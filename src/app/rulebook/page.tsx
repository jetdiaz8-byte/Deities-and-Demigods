            ...
            <Card className="bg-slate-800/50 border-slate-700">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  {[
                    { step: 1, label: 'Choose Your Action', desc: 'Select from 3-5 options generated by the AI. Options reflect your PC\'s abilities and the current situation.', color: 'border-blue-500/50' },
