...
export function GameSidebar({ state }: { state: GameState }) {
  ...
  return (
    <aside className="grid gap-4">
      <Card className="p-5">
        <h2 className="mb-3 flex items-center gap-2 font-title text-xl text-[var(--text-ivory)]"><Gem size={18} /> Shard</h2>
      ...
      <Card className="p-5">
        <h2 className="mb-3 flex items-center gap-2 font-title text-xl text-[var(--text-ivory)]"><HeartHandshake size={18} /> Companion</h2>
      ...
      <Card className="p-5">
        <h2 className="mb-3 flex items-center gap-2 font-title text-xl text-[var(--text-ivory)]"><Skull size={18} /> Antagonist</h2>
      ...
      <Card className="p-5">
        <h2 className="mb-3 flex items-center gap-2 font-title text-xl text-[var(--text-ivory)]"><Trophy size={18} /> Quests</h2>
